...
export default function Footertext() {
  return (
    <section class="FooterText-wrapper landingContainer">
      <article class="makeFlex footerText">
        <div className="descWidth">
          <h2 class="descHeading">Why MakeMyTrip?</h2>
          <div class="descText">
        ...
        <div className="descWidth">
          <h2 class="descHeading">Booking Flights with MakeMyTrip?</h2>
          <div class="descText">
        ...
        <div className="descWidth">
          <h2 class="descHeading">Domestic Flights with MakeMyTrip?</h2>
          <div class="descText">
